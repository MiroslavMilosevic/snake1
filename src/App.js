...
function App() {
  ...
  const [zmijaNiz, setZmijaNiz] = useState([
...
<Link to='home'>  <button  className='menuButton'>restart</button></Link>
        ...
        <Zmija pravac={pravac} setPravac={setPravac} pozicija={pozicija} setPozicija={setPozicija} zmijaNiz={zmijaNiz} setZmijaNiz={setZmijaNiz}/>
